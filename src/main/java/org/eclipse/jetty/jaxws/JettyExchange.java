...
public class JettyExchange extends HttpExchange {

	final HttpServletRequest request;
	final HttpServletResponse response;
	final JettyHttpContext context;

	Set<String> attrNames;
	Map<String, List<String>> requestHeaders;
	Map<String, List<String>> responseHeaders;

	JettyExchange(JettyHttpContext context, HttpServletRequest request, HttpServletResponse response) {
